...
{	meta:
	...
	date= "2024-11-5"
	hash1 = "1A94AA9F393B7D8391A64C68DDB28FEB"
	references = "https://blu3eye.gitbook.io/malware-insight/eset-wiper"
	strings:
...
rule eset_2nd_stage_wiper {
	...
	author = "Mohamed Talaat"
	date = "2024-11-5"
	hash1 = "C99D1339030A80567E8004B44B9FF924"
	references = "https://blu3eye.gitbook.io/malware-insight/eset-wiper"
	strings:
	$msg = "You can kill a people, but you can't kill an idea. Resistance will continue until the final liberation of all Palestinian lands, and it is only a matter of time"
	...
	condition:
	uint16(0) == 0x5a4d and $hex_xor_key and $cde_xor_loop and $cde_lcg and all of ($a*) and $msg
}
